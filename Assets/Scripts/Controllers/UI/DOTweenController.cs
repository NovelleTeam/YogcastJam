...
{
    public static void MoveToLocalXOneWayAndScale(Transform transform, float targetX, float moveDuration,
        Ease moveEaseType, float targetScale, float scaleDuration, Ease scaleEaseType, int loops, LoopType loopType)
    {
